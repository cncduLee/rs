package com.bitium10.rs.common.persistence;

import com.bitium10.rs.common.utils.CookieUtils;
...
/**
 * <b>项目名</b>： rs <br>
 * <b>包名称</b>： com.bitium10.rs.common.persistence <br>
 * <b>类名称</b>： Page <br>
 * <b>类描述</b>： <br>
 * <b>创建人</b>： <a href="mailto:shouli1990@gmail.com">李朋明</a> <br>
 * <b>修改人</b>： <br>
 * <b>创建时间</b>：2014/10/23 13:14
 * <b>修改时间</b>： <br>
 * <b>修改备注</b>： <br>
 *
 * @version 1.0.0 <br>
            ...
            for (String order : StringUtils.split(orderBy, ",")){
                ...
                if (o.length>=1){
                    ...
                    if ("DESC".equals(o[1].toUpperCase())){
                        orders.add(new Sort.Order(Sort.Direction.DESC, o[0]));
                    }else{
                        orders.add(new Sort.Order(Sort.Direction.ASC, o[0]));
                    }
                }
